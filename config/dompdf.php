...
return [
    ...
    */
    ...
    'public_path' => (function_exists('public_path') && realpath(public_path())) ? realpath(public_path()) : (realpath(base_path('public_html')) ?: (realpath(base_path('public')) ?: realpath(base_path()))),  // Override the public path safely for shared hosting/cPanel
