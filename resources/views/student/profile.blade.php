    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="p-4 text-white d-flex align-items-center justify-content-between gap-4"
                ...
                <div class="d-flex align-items-center gap-4">
                    ...
                    <div>
                        <h3 class="mb-1 fw-bold" style="font-family: 'Outfit', sans-serif;">
                            {{ auth('student')->user()->name }}'s Profile
                        </h3>
                ...
                <a href="{{ route('student.profile.edit') }}" class="btn btn-warning fw-bold px-4" style="border-radius: 8px; color: #0d1624;">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-header bg-white border-bottom" style="border-radius: 12px 12px 0 0; padding: 1.2rem 1.5rem;">
                    <h5 class="mb-0 fw-bold"><i class="fas fa-user me-2" style="color: #ce9d3c;"></i> Personal Information</h5>
                </div>
                <div class="card-body" style="padding: 1.5rem;">
                    ...
                    <table class="table table-borderless mb-0" style="font-size: 0.95rem;">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge" style="background-color: {{ $student->status === 'active' ? '#10b981' : '#ef4444' }}; font-size: 0.8rem;">
        ...
        <div class="col-md-6 mb-4">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-header bg-white border-bottom" style="border-radius: 12px 12px 0 0; padding: 1.2rem 1.5rem;">
                    <h5 class="mb-0 fw-bold"><i class="fas fa-lock me-2" style="color: #3b82f6;"></i> Account Stats</h5>
                </div>
                <div class="card-body" style="padding: 1.5rem;">
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="p-3 rounded-3 text-center" style="background: rgba(206,157,60,0.08);">
                                <i class="fas fa-file-alt mb-2" style="color: #ce9d3c; font-size: 2rem;"></i>
                        ...
                        <div class="col-6">
                            <div class="p-3 rounded-3 text-center" style="background: rgba(16,185,129,0.08);">
                                <i class="fas fa-check-circle mb-2" style="color: #10b981; font-size: 2rem;"></i>
                                <h4 class="fw-bold mb-0">0</h4>
                        ...
                        <div class="col-6">
                            <div class="p-3 rounded-3 text-center" style="background: rgba(59,130,246,0.08);">
                                <i class="fas fa-chart-bar mb-2" style="color: #3b82f6; font-size: 2rem;"></i>
                                <h4 class="fw-bold mb-0">N/A</h4>
                                <p class="text-muted small mb-0">Avg. Score</p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 rounded-3 text-center" style="background: rgba(139,92,246,0.08);">
                                <i class="fas fa-calendar-check mb-2" style="color: #8b5cf6; font-size: 2rem;"></i>
                                <h4 class="fw-bold mb-0">0</h4>
                                <p class="text-muted small mb-0">Pending Tests</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 mb-4">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-header bg-white border-bottom d-flex align-items-center justify-content-between" style="border-radius: 12px 12px 0 0; padding: 1.2rem 1.5rem;">
                    <h5 class="mb-0 fw-bold"><i class="fas fa-clipboard-list me-2" style="color: #10b981;"></i> My Tests & Results</h5>
                </div>
                <div class="card-body d-flex align-items-center justify-content-center" style="min-height: 200px;">
                    <div class="text-center text-muted py-4">
                        ...
                        <p class="mb-1">No tests have been assigned yet.</p>
