                ...
                <div class="question-group mb-5 {{ $p_idx === 0 ? '' : 'd-none' }}" data-group-id="{{ $part->id }}">
                    ...
                    <div class="group-instruction mb-4 p-3 bg-warning-subtle rounded-3 border-start border-warning border-4">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="fw-bold mb-0">Part {{ $part->part_number }} Instructions</h6>
                            <button type="button" class="btn btn-link btn-sm text-decoration-none btn-report-issue rounded-pill px-2 py-1" onclick="openReportModal('', 'Part {{ $part->part_number }} Instructions', '{{ $test->id }}', 'listening')" title="Report issue with Part {{ $part->part_number }} instructions">
                        ...
                        @foreach ($part->questions as $question)
                            ...
                            <div class="question-item mb-4 pb-4 border-bottom {{ $isHidden ? 'd-none' : '' }}" 
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <button type="button" class="btn btn-link btn-sm text-decoration-none btn-report-issue rounded-pill px-2 py-1" onclick="openReportModal('{{ $question->id }}', '{{ $question->question_number }}', '{{ $test->id }}', 'listening')" title="Report issue with Question #{{ $question->question_number }}">
                                        <i class="far fa-flag me-1"></i> Report Issue
                                    </button>
                                </div>
