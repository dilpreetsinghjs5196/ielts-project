            ...
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                ...
                <div class="card-body">
                    @if ($questionGroup->passage)
                        <div class="bg-white border p-4 rounded-3" style="max-height: 500px; overflow-y: auto; font-size: 1.15rem; line-height: 1.8; box-shadow: inset 0 2px 4px rgba(0,0,0,0.05);">
