...
<div class="row mb-4">
    <div class="col-12">
        ...
        <h2 class="mb-0 text-gray-800" style="font-weight: 700;">Add New Student</h2>
    </div>
</div>
                ...
                <form action="{{ route('admin.students.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="student_id" id="student_id" class="form-control @error('student_id') is-invalid @enderror" placeholder="e.g. STU001" value="{{ old('student_id') }}" required>
                            @error('student_id')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="e.g. +91 9876543210" value="{{ old('phone') }}">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" id="address" rows="3" class="form-control @error('address') is-invalid @enderror" placeholder="Student's address details...">{{ old('address') }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <p class="text-muted small mb-3"><i class="fas fa-lock me-1"></i> Set login credentials for this student</p>
                    ...
                    <div class="mt-4 d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary px-4" style="border-radius: 10px;">Save Student</button>
                    </div>
                </form>
            </div>
        </div>
