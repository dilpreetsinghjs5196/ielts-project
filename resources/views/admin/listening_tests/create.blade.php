...
<div class="row mb-4">
    <div class="col-12">
        @php
            $cancelUrl = route('admin.listening-tests.index', [
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb" style="background: transparent; padding: 0;">
                ...
                <li class="breadcrumb-item"><a href="{{ $cancelUrl }}">Listening Tests</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Listening Test</li>
            </ol>
        </nav>
        <h2 class="mb-0 text-gray-800" style="font-weight: 700;">Create New Listening Test</h2>
    </div>
</div>
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm" style="border-radius: 15px;">
            <div class="card-body p-4">
                <form action="{{ route('admin.listening-tests.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="mb-4">
                        <label for="name" class="form-label fw-bold small text-muted text-uppercase">Mock Test Name (Small Container)</label>
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g. Listening Test 01" value="{{ old('name') }}" required>
                        @error('name')
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <label for="audio_file" class="form-label fw-bold">Audio File (Optional)</label>
                    ...
                    <div class="mt-4 d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary px-4" style="border-radius: 10px;">Create Listening Test</button>
                    </div>
                </form>
            </div>
        </div>
